...
Es wird auf Bluetooth im Allgemeinen (klassisches Bluetooth) (\chapref{ch:general}) und auf \gls{bleLabel} (\chapref{ch:ble}) und deren Funktionsweisen sowie physikalischen Eigenschaften eingegangen.

Anschliessend werden verschiedene Alternativen (\chapref{ch:alt}) aufgezeigt, die ebenfalls eine drahtlose Verbindung anbieten.
