...
Der Paketinhalt kann via \gls{aesccmLabel} verschlüsselt werden. Dazu werden folgende fünf Werte benötigt:
...
\begin{table}[H]
	...
	\begin{tabular}{p{0.25\linewidth}lp{0.5\linewidth}}
		...
		Private Authentication Key & 128 Bit  & Wird jeweils von zwei paired Geräte verwendet. Kann auch \textit{Link Key} genannt werden.\\
...
Anschliessend wird ein gültiger Private Encryption Key für die effektive Verschlüsselung der Daten ausgemacht.

\subsection{Error Correction}
Abhängig des Packet Types werden die Daten mit einem \gls{crcLabel} kontrolliert.
